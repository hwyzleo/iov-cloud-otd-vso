 ...
 * @author hwyz_leo
 */
public class TestPurchaseBenefitsMapper extends BaseTest {

    @Autowired
    private PurchaseBenefitsMapper purchaseBenefitsMapper;
    ...
    public void testInsertPo() throws Exception {
        PurchaseBenefitsPo purchaseBenefitsPo = PurchaseBenefitsPo.builder()
                ...
                .enable(true)
                .build();
        purchaseBenefitsMapper.insertPo(purchaseBenefitsPo);
    }
