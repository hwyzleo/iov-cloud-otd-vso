...
/**
 * Model 销售策略 Mapper 接口
 *
 * @author hwyz_leo
 * @since 2026-06-01
 */
@Mapper
public interface SaleModelModelPolicyMapper extends BaseMapper<SaleModelModelPolicyPo> {
    ...
    @Delete("DELETE FROM vso_sale_model_model_policy WHERE sale_model_code = #{saleModelCode}")
